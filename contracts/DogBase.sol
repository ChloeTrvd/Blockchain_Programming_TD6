...
contract DogBase is DogAccessControl {
    ...
    event Birth(address owner, uint256 dogId, uint256 matronId, uint256 sireId, uint256 genes);
    ...
    mapping (uint256 => address) public dogIndexToOwner;
        ...
        returns (uint)
    {
        ...
        uint256 newDogId = kennel.push(_dog) - 1;
